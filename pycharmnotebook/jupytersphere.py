...
def SphereWidget():
    i = interact(
        ...
        sigsp=FloatSlider(min=0.01, max=10.0, step=.01, value=0.5, description="$\sigma_{sp}$"),

        thickob=FloatSlider(min=2.0, max=100.0, step=1, value=2, description="$t$"),

        depth=FloatSlider(min=-500.0, max=-10.0, step=1, value=-100.0, description="$d$"),

        txheight=FloatSlider(min=30.0, max=250.0, step=1, value=120.0, description="$tx_z$"),

        dipw=FloatSlider(min=0.0, max=360.0, step=1, value=135.0, description="$dip$"),
